...
function StreakFireComponent({ className = "" }: StreakFireProps) {
  return (
    <div
      className={`wrapped-flame pointer-events-none absolute inset-0 z-0 ${className}`}
      aria-hidden
    >
      <div className="wrapped-flame__mo-fire">
        <svg
          version="1.1"
          viewBox="0 0 125 189.864"
          xmlns="http://www.w3.org/2000/svg"
          className="wrapped-flame__svg"
        >
          <path
            className="wrapped-flame__flame-main"
            fill="#D9480F"
	...
	c6.806,41.899,16.831,45.301,6.088,53.985"
          />
          <path
            className="wrapped-flame__flame-main wrapped-flame__flame-main--one"
            fill="#F36E21"
	...
	c20.585,52.899-19.848,61.045-19.643,61.582c0.206,0.537-19.401-0.269-14.835-18.532S57.576,137.656,61.693,122.257z"
          />
          <path
            className="wrapped-flame__flame-main wrapped-flame__flame-main--two"
            fill="#FFD04A"
	...
	C84.858,184.21,125.705,150.905,81.657,79.192z"
          />
          <path
            className="wrapped-flame__flame-main wrapped-flame__flame-main--three"
            fill="#FDBA16"
	...
	C95.354,106.319,99.92,114.108,99.92,101.754z"
          />
          <path
            className="wrapped-flame__flame-main wrapped-flame__flame-main--four"
            fill="#F36E21"
...
export const StreakFire = memo(StreakFireComponent);
